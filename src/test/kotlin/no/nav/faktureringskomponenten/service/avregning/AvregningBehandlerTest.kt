...
class AvregningBehandlerTest {
    ...
    fun lagAvregningsfaktura() {
        ...
        avregningsfaktura.fakturaLinje shouldBe listOf(
            FakturaLinje(
                ...
                beskrivelse = "Tidligere fakturanummer: 123, nytt beløp: 10000,00 - tidligere beløp: 9000,00",
                antall = BigDecimal(1),
            ...
            FakturaLinje(
                ...
                beskrivelse = "Tidligere fakturanummer: 456, nytt beløp: 12000,00 - tidligere beløp: 9000,00",
                antall = BigDecimal(1),
    ...
    fun `lagAvregningsfaktura når bestilte fakturaer inneholder en avregningsfaktura`() {
        ...
        avregningsfaktura2.fakturaLinje.single() shouldBe FakturaLinje(
            periodeFra = LocalDate.of(2024, 1, 1),
            periodeTil = LocalDate.of(2024, 3, 31),
            beskrivelse = "Tidligere fakturanummer: ${avregningsfaktura2.eksternFakturaNummer}, nytt beløp: 11000,00 - tidligere beløp: 10000,00",
            antall = BigDecimal(1),
