...
**Eksempler:**
- `/aide-to-html MELOSYS-7637` - JIRA-sak
...
5. **Generer HTML:**
   ```bash
   # Pass riktig ID til aide-generate-html
   # JIRA: aide-generate-html MELOSYS-7890
   # TODO: aide-generate-html TODO-27-steg-ts-konvertering-analyse (full ID, ikke shorthand!)
   aide-generate-html <ID>
   ```

   **VIKTIG:** `aide-generate-html` scriptet trenger også å respektere `MELOSYS_AIDE_REPORTS_PATH`!
   ...
   - Output: `$REPORTS_ROOT/jira/<ID>/<ID>.html` eller `$REPORTS_ROOT/todo/<ID>/<ID>.html`
