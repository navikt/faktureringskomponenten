...
object dependencyVersions {
    ...
    const val shedlockVersion = "4.48.0"
    const val shedlockProvicerJdbcVersion = "4.48.0"
    const val mockkVersion = "1.13.3"
    const val springdocOpenapiStarter = "3.0.3"
    const val logstashLogbackEncoder = "7.2"
    const val tokenSupportVersion = "6.0.8"
